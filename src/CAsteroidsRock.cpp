 ...
 app_(app)
{
  ...
  if (! app_.getConfigValue("BigRock"   , "score", big_rock_score))
    big_rock_score = 20;
  if (! app_.getConfigValue("BigRock"   , "size" , big_rock_size_))
    big_rock_size_  = 0.07;

  if (! app_.getConfigValue("MediumRock", "score", medium_rock_score))
    medium_rock_score = 50;
  if (! app_.getConfigValue("MediumRock", "size" , medium_rock_size_))
    medium_rock_size_  = 0.035;

  if (! app_.getConfigValue("SmallRock" , "score", small_rock_score))
    small_rock_score = 100;
  if (! app_.getConfigValue("SmallRock" , "size" , small_rock_size_))
